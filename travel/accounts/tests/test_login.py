...
class TokenBlacklistTest(APITestCase):
    ...
    def test_token_blacklist_on_logout(self):
        ...
        url = reverse('logout')  # Assuming you'll create a logout endpoint
        data = {'refresh': str(self.refresh_token)}
...
class AuthenticationIntegrationTest(APITestCase):
    ...
    def test_full_authentication_flow(self):
        ...
        # 2. Access protected resource
        protected_url = reverse('user-profile')  # Assuming you'll create this endpoint
        ...
        # 5. Logout
        logout_url = reverse('logout')  # Assuming you'll create this endpoint
